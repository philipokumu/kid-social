                    ...
                    <b-navbar>
                        <template slot="brand">
                            <b-navbar-item tag="router-link" :to="{ path: '/' }">
                                <img
                                        src="images/kidslogo-144x 144.png"
                                        alt="The Kids Social Network Platform"
                                />
                            </b-navbar-item>
                                            ...
                                            <div class="follow-requests-container"
                                                ...
                                                <div class="follow-requests" v-if="isShowedFollowRequests">
                                                    <div class="follow-request mt-5"
                                                        v-for="follow_request in AUTH_USER.follow_requests" v-bind:key="follow_request.id">
...
//   import SideBarComponent from "../pages/Home/SideBarComponent";
//   import SideBarComponent from "..SideBarComponent/layouts/SideBarComponent";
//   import { SidebarMenu } from 'vue-sidebar-menu'

  export default {
    name: 'AppLayout',
    components: { BNavbarItem, BDropdownItem, BButton, BNavbarDropdown, SideNavMenu, SidebarMenuDrawer, /*SideBarComponent*/ },
    data () {
      return {
